package com.dreamcard.app.view.layout;
...
/**
 * Created by Moayed on 6/18/2014.
 */
public class MainLayout extends LinearLayout {
    // Duration of sliding animation, in miliseconds
    private static final int SLIDING_DURATION = 240;
    ...
    public MenuState currentMenuState = MenuState.HIDDEN;
