 ...
 */
public class CustomGridViewAdapterButton extends ArrayAdapter<GridItem> {
    ...
    public CustomGridViewAdapterButton(Context context, int layoutResourceId,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (item.isHasOffer()) {
            holder.getPnl().setBackground(this.context.getResources().getDrawable(R.drawable.category_btn_bg_press));
            holder.getPnl2().setBackground(this.context.getResources().getDrawable(R.drawable.category_btn_bg_press));
