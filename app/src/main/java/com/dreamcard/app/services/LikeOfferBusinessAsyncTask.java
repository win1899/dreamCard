 ...
 */
public class LikeOfferBusinessAsyncTask extends AbstractAsyncTask<Object, Void, Object> {
    ...
    public LikeOfferBusinessAsyncTask(IServiceListener listener,ArrayList<ServiceRequest> list,int processType,int type){
    ...
    private Object callService(){
        ...
        String method=ServicesConstants.WS_METHOD_LIKE_OFFER;
        if(this.type==Params.TYPE_LIKE_BUSINESS)
            method=ServicesConstants.WS_METHOD_LIKE_BUSINESS;
