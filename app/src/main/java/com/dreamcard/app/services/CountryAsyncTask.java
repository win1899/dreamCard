...
public class CountryAsyncTask extends AbstractAsyncTask<Object, Void, Object> {
    ...
    public CountryAsyncTask(IServiceListener listener,ArrayList<ServiceRequest> list,int processType){
    ...
    private Object callService(){
        ...
        String method= ServicesConstants.WS_METHOD_COUNTRIES;
                ...
                if(envelope.getResponse() instanceof SoapPrimitive){
                    ...
                    try {
                        ...
                        for (int i=0; i < jArray.length(); i++){
                            ...
                            bean.setName(oneObject.getString("Name"));
                            list.add(bean);
                        }
                        return list;
