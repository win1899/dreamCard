 ...
 */
public class FAQAsync extends AbstractAsyncTask<Object, Void, Object> {
    ...
    public FAQAsync(IServiceListener listener,ArrayList<ServiceRequest> list,int processType){
    ...
    private Object callService(){
        ...
        String method= ServicesConstants.WS_METHOD_FAQ;
                    ...
                    try {
                        ...
                        for (int i=0; i < jArray.length(); i++){
                            JSONObject oneObject = jArray.getJSONObject(i);
                                ...
                                bean.setQuastion(oneObject.getString("Question"));
                                bean.setAnswer(oneObject.getString("Answer"));
                                list.add(bean);
                        }
                        return list;
