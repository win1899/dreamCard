...
public class LikesNumAsync extends AsyncTask<Object, Void, Object> {
    ...
    public LikesNumAsync(IServiceListener listener,ArrayList<ServiceRequest> list,int processType,int type
        ,int offerPosition){
    ...
    private Object callService(){
        ...
        String method=ServicesConstants.WS_METHOD_TOTAL_OFFER_LIKES;
        if(this.type==Params.TYPE_BUSINESS)
            method=ServicesConstants.WS_METHOD_TOTAL_BUSINESS_LIKES;
        ...
        if (envelope.bodyIn instanceof SoapObject) {
            try {
                if(envelope.getResponse() instanceof SoapPrimitive){
                    ...
                    bean.setNumOfLikes(totalSaved);
                    bean.setOfferCode(this.offerPosition);
                    return bean;
                }
