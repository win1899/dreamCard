...
/**
 * Created by Moayad on 6/21/2015.
 */
public class OffersByFilterAsync extends AbstractAsyncTask<Object, Void, Object> {
    ...
    public OffersByFilterAsync(IServiceListener listener, ArrayList<ServiceRequest> list, int processType, int type) {
    ...
    private Object callService() {
        ...
        String method = ServicesConstants.WS_METHOD_OFFER_BY_FILTER;
