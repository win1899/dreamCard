...
/**
 * Created by Moayed on 9/10/2014.
 */
public class InterestCategoriesAsyncTask extends AbstractAsyncTask<Object, Void, Object> {
    ...
    public InterestCategoriesAsyncTask(IServiceListener listener,ArrayList<ServiceRequest> list,int processType){
    ...
    private Object callService(){
        ...
        String method= ServicesConstants.WS_METHOD_GET_INTEREST_CATEGORY;
                ...
                if(envelope.getResponse() instanceof SoapPrimitive){
                    ...
                    try {
                        ...
                        for (int i=0; i < jArray.length(); i++){
                            ...
                            map.put(oneObject.getString("Id"),oneObject.getString("Id"));
                        }
                        return map;
