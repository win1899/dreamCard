...
public class CheckActivationAsync extends AbstractAsyncTask<Object, Void, Object> {
    ...
    public CheckActivationAsync(IServiceListener listener,ArrayList<ServiceRequest> list,int processType){
    ...
    private Object callService(){
        ...
        for(int index=0;index<Params.SERVICE_REQUEST_COUNT;index++) {
            ...
            try {
                ...
                httpTransport.call(ServicesConstants.WS_ACTION+ServicesConstants.WS_METHOD_IS_CARD_AVAILABLE, envelope);
                break;
            } catch (Exception e) {
                ErrorMessageInfo bean = new ErrorMessageInfo();
...
//        }
    ...
    public SoapObject createRequest() {
        SoapObject request = new SoapObject(ServicesConstants.WS_NAME_SPACE, ServicesConstants.WS_METHOD_IS_CARD_AVAILABLE);
