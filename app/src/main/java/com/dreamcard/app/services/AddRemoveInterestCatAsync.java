 ...
 */
public class AddRemoveInterestCatAsync extends AbstractAsyncTask<Object, Void, Object> {
    ...
    public AddRemoveInterestCatAsync(IServiceListener listener,ArrayList<ServiceRequest> list,int processType,int type){
    ...
    private Object callService(){
        ...
        String method= ServicesConstants.WS_METHOD_ADD_INTEREST_CATEGORY;
        if(this.type== Params.TYPE_REMOVE_CATEGORY)
            method=ServicesConstants.WS_METHOD_REMOVE_INTEREST_CATEGORY;
