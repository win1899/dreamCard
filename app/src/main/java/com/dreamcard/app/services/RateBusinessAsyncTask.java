...
/**
 * Created by Moayed on 8/6/2014.
 */
public class RateBusinessAsyncTask extends AbstractAsyncTask<Object, Void, Object> {
    ...
    public RateBusinessAsyncTask(IServiceListener listener,ArrayList<ServiceRequest> list,int processType,int type){
    ...
    private Object callService(){
        ...
        String method= ServicesConstants.WS_METHOD_RATE_BUSINESS;

        if(type==Params.TYPE_OFFER){
            method=ServicesConstants.WS_METHOD_OFFER_RATE;
        }
